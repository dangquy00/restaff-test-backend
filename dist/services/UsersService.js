...
let UsersService = class UsersService {
    ...
    create(user) {
        return __awaiter(this, void 0, void 0, function* () {
            const findExist = yield this.connection.manager.findOne(User_1.User, { where: { username: user.username } });
            if (findExist)
                throw new ts_httpexceptions_1.HTTPException(enum_1.HttpCode.BADREQUEST, "Username has exist.");
    ...
    login(username, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                throw new ts_httpexceptions_1.HTTPException(enum_1.HttpCode.FORBIDDEN, "Login not success");
            if (!Utils_1.default.comparePassword(user.password, password))
                throw new ts_httpexceptions_1.HTTPException(enum_1.HttpCode.FORBIDDEN, "Login not success");
            const token = yield this.userSessionService.createSession(user);
            return { code: enum_1.HttpCode.SUCCESS, user: { fullname: user.fullname }, token };
        });
    }
    logout(token) {
        return __awaiter(this, void 0, void 0, function* () {
